<x-layout>
    ...
    <form action="{{ route('leader.update', ['leader' => $leader->id]) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="leader_name" id="leader_name" value="{{ old('leader_name', $leader->leader_name) }}"
        ...
        <div class="mb-4">
            ...
            <input type="date" name="leader_dob" id="leader_dob" value="{{ old('leader_dob', $leader->leader_dob) }}"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="leader_location" id="leader_location" value="{{ old('leader_location',  $leader->leader_location) }}"
        ...
        <div class="mb-4">
            ...
            <input type="email" name="leader_email" id="leader_email" value="{{ old('leader_email', $leader->leader_email) }}"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="leader_phone" id="leader_phone" value="{{ old('leader_phone', $leader->leader_phone) }}"
        ...
        <div class="mb-4">
            ...
            <input type="password" name="leader_password" id="leader_password" value="{{ old('leader_password', $leader->leader_password) }}"
